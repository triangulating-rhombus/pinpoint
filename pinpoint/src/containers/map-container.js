...
function mapStateToProps({ user, socket, allUsers, hotSpotVisibility, currentTagState, currentTagLabel }) {
  return { user, socket, allUsers, hotSpotVisibility, currentTagState, currentTagLabel };
}

export default connect(mapStateToProps, {setPoi, fetchTag, toggleTag })(MapView);
